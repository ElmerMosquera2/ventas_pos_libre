export class OfertasInventario extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        pElemento.textContent = 'Hola desde ofertas Inventario'
...
customElements.define('ofertas-inventario', OfertasInventario);