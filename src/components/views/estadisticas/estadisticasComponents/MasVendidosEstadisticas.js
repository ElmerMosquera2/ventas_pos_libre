export class MasVendidosEstadisticas extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        pElemento.textContent = 'Hola desde mas vendidos estadisticas'
...
customElements.define('mas-vendidos-estadisticas', MasVendidosEstadisticas);