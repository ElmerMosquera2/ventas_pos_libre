export class TendenciaEstadisticas extends HTMLElement {
    constructor() {
        super();
    ...
    render() {
        ...
        pElemento.textContent = 'Hola desde hora tendencia estadisticas'
...
customElements.define('tendencia-estadisticas', TendenciaEstadisticas);